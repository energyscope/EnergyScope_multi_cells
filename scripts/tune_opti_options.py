...
def one_run(ampl_options)
"""
    Function to run once ESMC with default parameters
    
    Parameters
    ----------
    ampl_options : dictionnary giving the options for ampl
