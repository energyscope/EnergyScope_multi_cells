...
- energy_carriers_Italy [7]: Conference paper on this case study: Whole-energy system model of Italy divided into 3 regions.
- esmc_v1 [5]: Master thesis with the first implementation of ENergyScope Multi-Cell. The methodology is detailed here.
